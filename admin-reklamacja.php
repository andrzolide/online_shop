...
<center>  <h2> Dane Reklamacji</h> </center>
 ...
 <div class="form-group row">
  ...
  <div class="col-sm">
<?php 
echo '<a href="functions/odrzuc-reklamacje.php?id_zwrotu='.$zwrot->getId().'"><button type="button" class="btn btn-danger">Odrzuć reklamacje</button></a>';
 ?>
  
    </div>
    <div class="col-sm">
<?php 
echo '<a href="functions/akceptuj-reklamacje.php?id_zwrotu='.$zwrot->getId().'"><button type="button" class="btn btn-success">Akceptuj reklamacje</button></a>';
 ?>
    </div>
